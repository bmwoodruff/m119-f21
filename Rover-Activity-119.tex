...
\end{tikzpicture}
\end{center}
The contours on the map represent a function $z=f(x,y)$, where $z$ is the elevation in meters, with contours drawn at 20 ft increments.  Each grid line represents 1000 ft. Suppose a hiker is currently at $A$. The hiker wants to get to $B$. Discuss the answers to each question below with your group.
